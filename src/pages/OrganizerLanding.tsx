...
const PLANS = [
  ...
  },
  {
    ...
    label: 'Intermédiaire',
    commission: '15%',
    tagline: 'Publication + Visibilité + DISICK',
    ...
    perks: [
      ...
      'Publication affiche + lien d\'achat sur les réseaux DISICK Man Show',
      'Story Instagram DISICK Man Show avec lien swipe-up vers la page d\'achat',
      'Mention TikTok DISICK Man Show avec contenu teaser',
  ...
  },
  {
    ...
    perks: [
      ...
      'Community manager DISICK dédié à votre événement',
