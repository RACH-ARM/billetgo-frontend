  ...
  return (
    <div style={{ fontFamily: 'Georgia, serif', color: '#111', background: '#fff', maxWidth: 800, margin: '0 auto', padding: '40px 48px', fontSize: 13, lineHeight: 1.7 }}>
      ...
      <section style={{ marginBottom: 20 }}>
        ...
        <p>En cas d'annulation ou de report, l'Organisateur doit notifier BilletGo par email à <strong>support@billetgo.ga</strong> dans les <strong>24 heures</strong> suivant la décision, et utiliser la fonctionnalité « Annuler l'événement » depuis son tableau de bord.</p>
      ...
      <div style={{ border: '1px solid #ccc', borderRadius: 6, padding: '16px 20px', marginTop: 32 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginTop: 16 }}>
          <div style={{ borderTop: '1px solid #999', paddingTop: 8 }}>
            ...
            <p style={{ margin: '4px 0 0', fontSize: 12 }}>BilletGo — billetgo.ga</p>
          </div>
          <div style={{ borderTop: '1px solid #999', paddingTop: 8 }}>
      ...
      <p style={{ marginTop: 24, fontSize: 11, color: '#888', textAlign: 'center' }}>
        BilletGo — support@billetgo.ga — billetgo.ga — Document généré le {now}
      </p>
    </div>
  );
}
