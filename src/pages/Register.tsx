        ...
        {role === 'BUYER' && (
          <>
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 px-4 py-3 text-sm text-white/80 transition-colors mb-2"
            >
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2 px-3 py-2.5 rounded-xl bg-amber-500/10 border border-amber-500/20">
                ...
                <p className="text-xs text-amber-200/70 leading-relaxed">
                  En tant qu'organisateur, vous devez lire et accepter les Conditions Générales Organisateur (CGO) qui encadrent les versements, la protection anti-annulation et vos obligations légales.
                </p>
              </div>
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                ...
                <span className="text-xs text-white/50 leading-relaxed">
                  ...
                  <Link to="/contrat-organisateur" target="_blank" className="text-violet-neon hover:underline font-semibold">
                    Conditions Générales Organisateur (CGO) — Version 1.0
                  </Link>
                  , incluant les obligations de remboursement en cas d'annulation d'événement après versement de fonds.
                </span>
              </label>
            </div>
          )}
