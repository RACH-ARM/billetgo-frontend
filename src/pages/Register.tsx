...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      ...
      >
        <h1 className="font-bebas text-4xl tracking-wider text-gradient mb-2">INSCRIPTION ORGANISATEUR</h1>
        <p className="text-white/50 text-sm mb-6">Créez votre compte organisateur et publiez vos événements</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            ...
            size="lg"
            isLoading={isLoading}
            disabled={!cguAccepted || !cgoAccepted}
