    ...
    <div className="glass-card p-5 border border-violet-neon/15 space-y-4">
      ...
      <div className="space-y-4 text-sm">
        {[
          {
            n: '1',
            title: 'Vérifiez votre email et WhatsApp',
            body: "Vous allez recevoir votre QR code d'entrée par email et/ou WhatsApp. Vérifiez aussi votre dossier spam si vous ne le voyez pas dans les prochaines minutes.",
          },
          {
            n: '2',
            title: "Le jour de l'événement",
            body: "Ouvrez le message BilletGab, affichez votre QR code et présentez votre écran à l'entrée. Vous pouvez aussi l'enregistrer dans votre galerie pour un accès hors connexion.",
          },
          {
            n: '3',
            title: 'Retrouver vos billets',
