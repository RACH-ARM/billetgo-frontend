...
export default function Confidentialite() {
  ...
  const handleDownload = async () => {
    setDownloading(true);
    try {
      const response = await api.get('/utils/confidentialite.pdf', { responseType: 'blob' });
  ...
  return (
    <div className="min-h-screen bg-bg py-20 px-4">
      <Helmet>
        <title>Politique de confidentialité | BilletGab</title>
          ...
          <Section title="4. Partage des données">
            ...
            <ul className="list-disc list-inside space-y-1 pl-2">
              ...
              <li>
                ...
                (cache et file d'attente), Resend (emails transactionnels), tous soumis à des obligations
