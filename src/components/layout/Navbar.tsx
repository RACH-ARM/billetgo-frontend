...
import { ShoppingCart, Ticket, LayoutDashboard, ShieldCheck, ScanLine, LogOut, Menu, X, MailWarning, UserCircle, ShoppingBag, TrendingUp } from 'lucide-react';
...
const ROLE_CONFIG = {
  ...
  INFLUENCER: { label: 'Dashboard',  Icon: TrendingUp,  path: '/influencer' },
};
